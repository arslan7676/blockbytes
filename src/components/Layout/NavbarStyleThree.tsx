        ...
        <div className="container mx-auto lg:max-w-[1710px]">
          ...
          >
            ...
            <div className="navbar-collapse flex self-center grow basis-auto">
              <ul className="navbar-nav self-center flex-row mr-auto rtl:mr-0 rtl:ml-auto xl:flex xl:pl-[35px] rtl:xl:pl-0 rtl:xl:pr-[35px] 2xl:pl-[70px] rtl:2xl:pl-0 rtl:2xl:pr-[70px]">
              ...
              {/* Other options */}
              <div className="other-options self-center sm:flex sm:items-center sm:space-x-[20px] rtl:space-x-reverse space-y-[20px] sm:space-y-[0] border-t border-[#eeeeee] pt-[20px] xl:pt-[0] pb-[10px] xl:pb-[0] xl:border-none xl:ml-[40px] rtl:xl:ml-0 rtl:xl:mr-[40px]2xl:ml-[30px] rtl:2xl:ml-0 rtl:2xl:mr-[30px]">
                {/* SearchForm */}
                <SearchForm />
