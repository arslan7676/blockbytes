        ...
        <div className="container mx-auto lg:max-w-[1710px]">
          ...
          >
            ...
            <div className="navbar-collapse flex self-center grow basis-auto">
              ...
              {/* Other options */}
              <div className="other-options self-center border-t border-[#eeeeee] pt-[20px] xl:pt-[0] pb-[10px] xl:pb-[0] xl:border-none xl:ml-[40px] xl:rtl:ml-0 xl:rtl:mr-[40px] 2xl:ml-[80px] 2xl:rtl:ml-0 2xl:rtl:mr-[80px]">
                <Link
                  href="/contact-us/"
