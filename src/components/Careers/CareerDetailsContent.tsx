          ...
          <div className="bg-[#fff] border border-[#E3E3E3] rounded-[20px] py-[30px] md:py-[55px] px-[30px] md:px-[65px]">
            ...
            <div className="grid items-center grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 mb-[30px] md:mb-[50px]">
              ...
              <div className="lg:text-end">
                <ul className="space-x-[20px] rtl:space-x-reverse space-y-[10px] lg:space-y-[0]">
                  <li className="inline-block">
                    <div className="flex items-center">
                      <div className="shrink-0 bg-[#E3E3E3] w-[32px] h-[32px] leading-[28px] text-center rounded-full text-[20px] mr-[10px] rtl:mr-0 rtl:ml-[10px]">
                        <svg
            ...
            <div className="space-y-5 md:space-y-10">
              ...
              <div className="space-y-3">
                <p className="text-black">
                  <strong>Open Number of Position:</strong>
                </p>
                <p>05</p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p>
                  You will be responsible for managing all SEO activities such
                  as content strategy, link building, and keyword strategy to
                  increase rankings on all major search networks. You will also
                  manage all SEM campaigns on Google, Yahoo, and Bing to
                  maximize ROI.
                </p>

                <ul className="space-y-2">
                  <li>
                    – Work with and support other Search Engineers, Internet
                    Marketers, Designers, Programmers, Art and Creative
                    Directors on high-end websites.{" "}
                  </li>
                  <li>
                    – Develop your skills and augment your training with
                    directed research in your very specific tasks.{" "}
                  </li>
                  <li>
                    – Use the online productivity platform Asana to organize and
                    keep track of your completed tasks.
                  </li>
                  <li>
                    – Get constant feedback and suggestions on how to improve
                    your skills.{" "}
                  </li>
                  <li>
                    – Break through barriers and confusion by working with the
                    team before you are frustrated with tasks.{" "}
                  </li>
                  <li>
                    – Be certain you are studying and practicing the most
                    important daily skills you need to be an elite level
                    internet marketer and search engine optimizer{" "}
                  </li>
                  <li>
                    – Coordinates with individual brand managers to maintain
                    website content in a timely manner.{" "}
                  </li>
                  <li>
                    – Configures websites to deliver functionality and
                    promotions as directed.{" "}
                  </li>
                  <li>
                    – Generates and analyzes SEO reports, monitors opportunities
                    for improvement, and implements SEO changes to the websites
                  </li>
                  <li>
                    – Audits website content for reliability, accuracy, and
                    usability. Updates website metadata and content daily to
                    ensure relevance and accuracy.
                  </li>
                  <li>
                    Other Skills: Google Analytics, Internet Marketing, Link
                    Building, Off-page Optimization, On-Page Optimization,
                    Search Engine Optimization (SEO), SEO Audit, SEO
                    Backlinking, SEO Keyword Research, Social Media Marketing
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-3">
                ...
                <ul className="list-disc space-y-2 pl-[17px]">
                  ...
                  <li>
                    Ideally 4 years of experience in social media management,
                    preferably in the nutrition, health, or wellness industry.
                    Provide a portfolio or examples of successful social media
                    campaigns.
                  </li>
                  <li>
                    Strong understanding of various social media platforms,
                    their features, algorithms, and best practices. Proficiency
                    in using social media management and analytics tools.
                  </li>
                  <li>
                    Excellent copywriting skills with the ability to create
                    engaging and compelling content. Proficiency in graphic
                    design and video editing software is not a requirement but
                    is a plus.
                  </li>
                  <li>
                    Experience in identifying, collaborating with, and managing
                    influencers for successful marketing campaigns. Familiarity
                    with influencer marketing platforms and tools.
                  </li>
                  <li>
                    Ability to develop and execute social media strategies
                    aligned with business goals. Strong analytical skills to
                    track metrics, analyze data, and make data-driven decisions.
                  </li>
                  <li>
                    Proven track record of creating innovative social media
                    campaigns and content ideas. Ability to think outside the
                    box and stay updated with the latest trends.
                  </li>
                  <li>
                    Excellent communication and interpersonal skills to
                    effectively collaborate with internal teams, external
                    partners, and influencers.
                  </li>
                  <li>
                    Strong work ethic and a desire to continuously learn and
                    improve
                  </li>
                  <li>
                    A scrappy, startup mindset, with no fear of taking ownership
                    to develop and drive your vision
                  </li>
                  <li>
                    The desire to win, with an inherently competitive spirit
                  </li>
                  <li>
                    You live, breathe, eat, sleep, and dream social media; if
                    talking about the TikTok algorithm doesn't excite you, this
